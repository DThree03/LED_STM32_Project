...
const uint8_t  TM1637_CODE_SEG_NO_DOT[20] = {0x77, 0x41, 0x3B, 0x6B, 0x4D, 0x6E, 0x7E, 0x43, 0x7F, 0x6F, 0x00, 0xFF, 0x5A};
const uint8_t  TM1637_CODE_SEG_HAS_DOT[20] = {0xF7, 0xC1, 0xBB, 0xEB, 0xCD, 0xEE, 0xFE, 0xC3, 0xFF, 0xEF, 0x00, 0xFF, 0x5A};

const uint8_t   TM1637_CODE_LED[20]={0x00,0x80,0x88,0x8C,0x9C,0xBC,0xFC,0xFD,0xFF};//VALUE_SHOW_LED[2]
const uint8_t   TM1637_CODE_LED_1[20]={0x00,0x02,0x03,0x43,0x63,0x73,0x77,0x7F,0xFF};//VALUE_SHOW_LED[3]

const uint8_t VALUE_SHOW_LED_2_CONST[11] = {0xE7,0x84,0xD3,0xD6,0xB4,0x76,0x77,0xC4,0xF7,0xF6,0x00};
const uint8_t VALUE_SHOW_LED_3_CONST[11] = {0xBE,0x12,0x7C,0x7A,0xD2,0xEA,0xEE,0x32,0xFE,0xFA,0x00};
